...
function Show-BrukerveiledningDialog {
    ...
    $fanetekster = [ordered]@{
        ...
        'Avansert og Verktøy' = """Avansert...""`r`n" +
            ...
            "OCCT (occt.app) er et nyttig, uavhengig verktøy for å dobbeltsjekke at en undervolting-verdi faktisk er stabil over lengre tid - men er ikke noe Manageren styrer eller integrerer med, og må brukes helt på egen hånd ved siden av."
