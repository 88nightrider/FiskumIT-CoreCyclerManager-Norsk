...
- **IntelVoltageControl** (bundlet i `CoreCycler/tools/`) er skrevet av [jamestut](https://github.com/jamestut/IntelVoltageControl) (MIT, se [`IntelVoltageControl-LICENSE-MIT.txt`](CoreCycler/tools/IntelVoltageControl/IntelVoltageControl-LICENSE-MIT.txt)) og bruker WinRing0 for MSR-tilgang, som har sin egen lisens, se [`LICENSE.txt`](CoreCycler/tools/IntelVoltageControl/LICENSE.txt) i samme mappe. En forberedt (men IKKE bygget/testet) patch som bytter WinRing0 ut med [PawnIO](https://github.com/namazso/PawnIO) - en nyere, signert driver flere store verktøy har gått over til siden WinRing0 nå flagges av antivirus (CVE-2020-14979) - ligger i [`CoreCycler/tools/IntelVoltageControl/PawnIO-patch/`](CoreCycler/tools/IntelVoltageControl/PawnIO-patch/BYGG-OG-PATCH-README.txt).
